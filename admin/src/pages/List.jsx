        ...
        <div>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2  bg-gray-100 text-sm'>
                    <strong className='text-xl font-bold'>Image</strong>
                    <strong className='text-xl font-bold'>Name</strong>
                    <strong className='text-xl font-bold'>Category</strong>
                    <strong className='text-xl font-bold'>Price</strong>
                    <strong className='text-center text-xl font-bold'>Action</strong>
                </div>

                {/* product list */}
                {
                    list.map((item, index) => (
                        <div className='grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 bg-gray-100 text-sm' key={index}>
