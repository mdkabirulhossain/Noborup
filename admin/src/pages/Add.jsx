...
const Add = ({ token }) => {
    ...
    return (
        <form onSubmit={onSubmitHander} action="" className='flex flex-col w-full items-start'>
            <div>
            ...
            <div className='w-full'>
                ...
                <input onChange={(e) => setName(e.target.value)} value={name} type="text" className='w-full max-w-[500px] p-2' placeholder='type here' name="" id="" required />
            </div>
            <div className='w-full'>
                <p className='mb-2'>Product description</p>
                <textarea onChange={(e) => setDescription(e.target.value)} value={description} type="text-area" className='w-full max-w-[500px] p-2' placeholder='write content here' name="" id="" required />
            </div>
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input onChange={(e) => setPrice(e.target.value)} value={price} type="Number" className='w-full px-3 py-2 sm:w-[120px]' placeholder='please enter the price' />
                </div>
            </div>
            <div>
            ...
            <button type='submit' className='w-28 cursor-pointer py-3 mt-4 bg-black text-white'>ADD</button>
        </form>
    );
};
