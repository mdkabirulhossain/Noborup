    ...
    const loadOrderData = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                // Set the state with the processed orders
            ...
            <div>
                {
                    orderData.map((item, index) =>
                        <div key={index} className='border-t py-4 text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
