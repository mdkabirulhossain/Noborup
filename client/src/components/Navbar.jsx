...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            {/* logo  */}
            <div>
                <h1 className='text-2xl'>NOBORUP</h1>
            </div>
            {/* Navigations Links  */}
            <div>
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    <div className='hidden group-hover:block absolute right-0 pt-4 bg-white shadow-md rounded'>
                        <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
                            ...
                            <p className='cursor-pointer hover:block'>Logout</p>
                        </div>
                    </div>
                </div>
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-0 bottom-[-5px] w-4 text-center leading-4 bg-black text-white rounded-full text-[8px]'>0</p>
                </Link>
