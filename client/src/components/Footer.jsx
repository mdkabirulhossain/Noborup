  ...
  return (
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        <div>
            <p className='mb-5 text-2xl font-bold'>NOBORUP</p>
        ...
        <div>
            ...
            <ul className='flex flex-col gap-1 text-gray-600'>
                ...
                <li>info@noborup.com</li>
            </ul>
        </div>
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright 2024@ Noborup.com - All rights reserved.</p>
        </div>
      </div>
    </div>
  )
